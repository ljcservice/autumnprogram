...
public class SaveOperaction extends Persistent4DB implements ISaveOperaction
{
    public void saveOperaction(TCommonRecord tcr) throws Exception
    {
        ...
        StringBuffer sb = new StringBuffer("insert into EXARECORDS (ID,IP,ORDERS_OBJ,ANTI_OVER,ANTI_NUM,DRUG_OVER,MEDICAL_OVER,DRUG_ORDERS_NUM,");
        ...
        System.out.println("审查结果插入:审查时间:" + tcr.get("OPERATION_DATE") + ": 审查医生:" + tcr.get("DOCTOR_NAME") + " 审查部门 :" + tcr.get("DEPT_NAME"));
