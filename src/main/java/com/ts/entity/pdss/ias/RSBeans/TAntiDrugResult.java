...
public class TAntiDrugResult
{
	...
	public TAntiDrugResult() {}
	
	public TAntiDrugResult(String ACheckType , String AMemo , boolean AResult) 
	{
	...
	public TAntiDrugResult(String ACheckType , String AMemo , boolean AResult,String tilte) 
    {
	    this.tilte     = tilte;
        this.CheckType = ACheckType;
        this.Memo      = AMemo;
   ...
   public TAntiDrugResult(String ACheckType , String AMemo , boolean AResult,String tilte,String[] ABak) 
    {
        this.tilte     = tilte;
        this.CheckType = ACheckType;
        this.Memo      = AMemo;
