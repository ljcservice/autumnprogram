 ...
 * @date 2016-4-9
 */
public class QuartzFecherManager {  
    private static SchedulerFactory gSchedulerFactory = new StdSchedulerFactory();  //创建一个SchedulerFactory工厂实例
    private static String JOB_GROUP_NAME = "Fecher_JOBGROUP_NAME";  					//任务组
    private static String TRIGGER_GROUP_NAME = "Fecher_TRIGGERGROUP_NAME";  			//触发器组
