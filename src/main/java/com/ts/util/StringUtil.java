...
public class StringUtil {
    ...
    public static String strToUrlcode(String value){
    	try {
			...
			Logger.getLogger(StringUtil.class).error("字符串转换为URLCode失败,value:" +value, e);   
			e.printStackTrace();
			return null;
		}    
    }
    ...
    public static String urlcodeToStr(String value){
    	try {
			...
			Logger.getLogger(StringUtil.class).error("URLCode转换为字符串失败;value:" + value,e);
			e.printStackTrace();
			return null;
		}  
    }
