...
public class AESDecode {
    ...
    public static void main(String[] args) throws Exception {
        // 发送POST请求示例
        String ak_id = "LTAInG2mNjX5WzZ6"; //用户ak
        String ak_secret = "JXdoH2lfaWLmsrXZAXF8VVAPx78ARc"; // 用户ak_secret
        String url = "https://dtplus-cn-shanghai.data.aliyuncs.com/dt_ng_1646870980837502/nlp/api/ReviewAnalysis/ecommerce";
        String body = "{\"text\": \"面料舒适，款式好，只是尺码偏小，好在我看了其他买家的评价，在原尺码上加了一号，正合适，很满意！给满分！服务好，发货快！\"}";
