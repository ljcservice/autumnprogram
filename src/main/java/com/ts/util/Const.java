...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((show)|(plugins)|(login)|(logout)|(code)|(app)|(pdss)|(weixin)|(static)|(main)|(websocket)|(services)|(js)|(images)).*";	//不对匹配该值的访问路径拦截（正则）
