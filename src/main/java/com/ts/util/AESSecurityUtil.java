...
//    public static final String CIPHER_ALGORITHM = "AES/ECB/NoPadding";
    ...
    public static void main(String[] args) throws Exception{
        System.out.println("生成key============"+getKeyStr());
        String jimm = "颈椎病，偏身麻木";
        
        String mw = AESSecurityUtil.encrypt(jimm,"VxDksHQiTvQt9MMPtMVXdA==");
        System.out.println("密文:" + mw);

        String jm = AESSecurityUtil.decrypt(mw,"VxDksHQiTvQt9MMPtMVXdA==");
