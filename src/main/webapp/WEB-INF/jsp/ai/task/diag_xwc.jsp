		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="taskQuery/saveDiagRs.do" name="xwcForm" id="xwcForm" method="post">
									...
									<input type="hidden" name="DIS_TYPE" id="DIS_TYPE" value="2"/><!-- 处理类型 下位词 -->
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="width:99px;text-align: right;padding-top: 13px;">父节点名称:</td>
											<td>
											<textarea rows="2" name="STAD_CNS" id="STAD_CNS"  readonly="readonly" cols="40"  title="标准术语" style="width:78%;">${pd.STAD_CNS }</textarea>
												<input type="hidden" name="STD_ID" id="STD_ID" value="${pd.STAD_IDS }"/>
												<input type="hidden" name="D_IDS" id="D_IDS" value="${pd.D_IDS }"/>
											</td>
										</tr>
										<tr>
