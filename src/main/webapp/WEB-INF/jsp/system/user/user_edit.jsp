								...
								<form action="user/${MSG }.do" name="userForm" id="userForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><input type="text" name="REMARK" id="BZ" value="${pd.REMARK }" placeholder="这里输入备注" maxlength="300" title="备注" style="width:98%;"/></td>
										</tr>
										<tr>
										...
										<tr>
											<td style="text-align: center;" colspan="10">
												<c:if test="${MSG=='add'}">
													<ts:rights code="user/add"><a class="btn btn-mini btn-primary" onclick="save();">保存</a></ts:rights>
												</c:if>
												<c:if test="${MSG=='edit'}">
													<ts:rights code="user/edit"><a class="btn btn-mini btn-primary" onclick="save();">保存</a></ts:rights>
												</c:if>
