...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						...
						<form  action="menu/${MSG }.do" name="menuForm" id="menuForm" method="post" class="form-horizontal">
							...
							<input type="hidden" name="MENU_STATUS" id="MENU_STATUS" value="${pd.MENU_STATUS }"/>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" name="MENU_NAME" id="menuName" value="${pd.MENU_NAME }" placeholder="这里输入菜单名称" class="col-xs-10 col-sm-5" maxlength="80"/>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<input type="text" name="MENU_URL" id="menuUrl" value="${pd.MENU_URL }" placeholder="这里输入菜单链接" class="col-xs-10 col-sm-5" maxlength="200"/>
									</c:if>
									<c:if test="${null == pds.MENU_NAME}">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" name="MENU_ORDER" id="menuOrder" value="${pd.MENU_ORDER}" placeholder="这里输入菜单序号" title="请输入正整数" class="col-xs-10 col-sm-5" maxlength="6" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<label style="float:left;padding-left: 8px;padding-top:7px;">
										<input name="form-field-radio2" type="radio" class="ace" id="form-field-radio3" <c:if test="${pd.MENU_STATUS == 1 }">checked="checked"</c:if> onclick="setType('2',1);"/>
										<span class="lbl"> 显示</span>
									</label>
									<label style="float:left;padding-left: 5px;padding-top:7px;">
										<input name="form-field-radio2" type="radio" class="ace" id="form-field-radio4" <c:if test="${pd.MENU_STATUS == 0 }">checked="checked"</c:if> onclick="setType('2',0);"/>
							...
							<div class="clearfix form-actions">
								<div class="col-md-offset-3 col-md-9">
									<c:if test="${MSG =='add'}">
										<ts:rights code="menu/add"><a class="btn btn-mini btn-primary" onclick="save();">保存</a></ts:rights>
									</c:if>
									<c:if test="${MSG =='edit'}">
										<ts:rights code="menu/edit"><a class="btn btn-mini btn-primary" onclick="save();">保存</a></ts:rights>
									</c:if>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			if(Number($("#menuOrder").val())>999999){
				$("#menuOrder").tips({
					side:1,
		            msg:'请输入6位以内整数',
		            bg:'#AE81FF',
