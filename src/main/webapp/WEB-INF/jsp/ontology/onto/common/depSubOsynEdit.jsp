...
function save(){
	...
	var tr_all = 
			"<tr>"+
				...
				"<td width='100px;'>术语名称中文:</td><td style='max-width:250px;'>"+$("#DN_CHN").val()+"</td><td width='90px;'>同义词类型:</td><td  width='110px;'>"+$('select#SYNO_TYPE option:selected').text()+"</td>"+
				"<td width='75px;'>停用标记:</td><td width='75px;'>"+$("input[name='IS_DISABLE']:checked").attr("text")+"</td></td><td width='75px;'>停用描述:</td><td style='max-width:250px;'>"+$("#DESCRIPTION").val()+"</td>"+
				"<td width='100px;' style='vertical-align: middle;' align='center'>"+
