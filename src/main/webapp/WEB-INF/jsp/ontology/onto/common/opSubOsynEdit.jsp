...
function save(){
	...
	var tr_all = 
			"<tr>"+
				...
				"<td width='100px;'>术语名称中文:</td><td style='max-width:250px;'>"+$("#DN_CHN").val()+"</td><td width='130px;'>术语来源名称中文:</td><td style='max-width:250px;'>"+$("#ORG_DN_CHN").val()+"</td><td width='100px;'>同义词类型:</td><td>"+$('select#SYNO_TYPE option:selected').text()+"</td><td width='75px;'>停用标记:</td><td>"+$("input[name='IS_DISABLE']:checked").attr("text")+"</td>"+
				...
				"</td>"+
			"</tr>"+
			"<tr><td>术语名称英文:</td><td>"+$("#DN_ENG").val()+"</td><td>术语来源名称英文:</td><td>"+$("#ORG_DN_ENG").val()+"</td><td>停用描述:</td><td style='max-width:250px;' colspan='3'>"+$("#DESCRIPTION").val()+"</td></tr>";
	if($("#tableId").val()==""){
		//新增
