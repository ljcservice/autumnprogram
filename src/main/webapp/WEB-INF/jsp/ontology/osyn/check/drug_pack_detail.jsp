					...
					<div class="row">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							...
							<tbody id="standTbody">
								...
								<tr>
									<td align="right">来源-药品标准包装材质_中文：</td>
									<td>${pd.ORG_STAD_DP_CHN }</td>
									<td>${pd_new.ORG_STAD_CHN}</td>
								</tr>
								<tr>
									<td align="right">来源-药品标准包装材质_英文：</td>
									<td>${pd.ORG_STAD_DP_ENG }</td>
