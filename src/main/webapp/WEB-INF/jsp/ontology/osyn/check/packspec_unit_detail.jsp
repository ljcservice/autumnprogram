					...
					<div class="row">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							...
							<tbody id="standTbody" align="center">
								...
								<tr>
									<td align="right">来源-药品规格单位_英文：</td>
									<td>${pd.ORG_PSU_ENG }</td>
								...
								<tr>
									<td align="right">来源-药品标准规格单位_中文：</td>
									<td>${pd.ORG_PSU_STAD_CHN }</td>
									<td>${pd_new.ORG_STAD_CHN}</td>
								</tr>
								<tr>
									<td align="right">来源-药品标准规格单位_英文：</td>
									<td>${pd.ORG_PSU_STAD_ENG }</td>
									<td>${pd_new.ORG_STAD_ENG}</td>
								</tr>
								<tr>
									<td align="right">备注：</td>
									<td>${pd.REMARK }</td>
									<td>${pd_new.DRUG_MEMO}<c:if test="${pd_new.OP_TYPE<=1 }"><span class="edit" onclick="setInput(this,'DN_CHN','${pd_new.DN_CHN}');"></span></c:if></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>${pd_new.DESCRIPTION}<c:if test="${pd_new.OP_TYPE<=1 ||pd_new.OP_TYPE==4}"><span class="edit" onclick="setInput(this,'DN_CHN','${pd_new.DN_CHN}');"></span></c:if></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="2"><input type="text" name="CHECK_MEMO" style="width: 90%;"/></td>
								</tr>
								<tr id="showConsol">
