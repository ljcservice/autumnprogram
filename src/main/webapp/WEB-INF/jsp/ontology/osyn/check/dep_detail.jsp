			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<input type="hidden" name="DN_ID" value="${pd_new.DN_ID }"/>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							...
							<tbody id="standTbody" align="center">
								<tr>
									<td align="right" width="24%">科室名称:</td>
									<td width="38%">${pd.DEP_NAME }</td>
								...
								<tr>
									...
									<td><c:if test="${pd_new.IS_DISABLE ==0 }">否</c:if><c:if test="${pd_new.IS_DISABLE ==1 }">是</c:if><c:if test="${pd_new.OP_TYPE <=1 || pd_new.OP_TYPE==4}"><span class="edit" onclick="setSelect(this,'IS_DISABLE');"/></span></c:if></td>
								</tr>
								<tr>
						...
						<div style="padding: 0px;margin: 4px;vertical-align: middle;text-align: center;">
							<c:if test="${pd_new.STATUS==0 }">
								...
								<ts:rights code="OSYN_REFUSE_PASS_${RIGHTS}">
