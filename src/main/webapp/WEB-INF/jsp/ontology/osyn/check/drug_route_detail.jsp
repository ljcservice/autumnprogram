				...
				<div class="page-content">
					<div class="row">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							...
							<tbody id="standTbody">
								<tr>
									<td align="right">给药途径名称_中文：</td>
									<td>${pd.DR_CHN }</td>
									<td>${pd_new.DN_CHN}<c:if test="${pd_new.OP_TYPE<=1 }"><span class="edit" onclick="setInput(this,'DN_CHN','${pd_new.DN_CHN}');"></span></c:if></td>
								</tr>
								<tr>
									<td align="right">给药途径名称_英文：</td>
									<td>${pd.DR_ENG }</td>
									<td>${pd_new.DN_ENG}<c:if test="${pd_new.OP_TYPE<=1 }"><span class="edit" onclick="setInput(this,'DN_ENG','${pd_new.DN_ENG}');"></span></c:if></td>
								</tr>
								<tr>
									<td align="right">给药途径名称_英文缩写：</td>
									<td>${pd.DR_ENG_ABB }</td>
									<td>${pd_new.FAC_ABB}<c:if test="${pd_new.OP_TYPE<=1 }"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.FAC_ABB}');"></span></c:if></td>
								</tr>
								<tr>
									<td align="right">标准给药途径名称_中文：</td>
									<td>${pd.STAD_DR_CHN }</td>
									<td>${pd_new.STAD_CHN}</td>
								</tr>
								<tr>
									<td align="right">标准给药途径名称_英文：</td>
									<td>${pd.STAD_DR_ENG }</td>
									<td>${pd_new.STAD_ENG}</td>
								</tr>
								<tr>
									<td align="right">概念：</td>
									<td>${pd.CONCEPT }</td>
									<td>${pd_new.COUNTRY}<c:if test="${pd_new.OP_TYPE<=1 }"><span class="edit" onclick="setInput(this,'COUNTRY','${pd_new.COUNTRY}');"></span></c:if></td>
								</tr>
								<tr>
									<td align="right">概念来源：</td>
									<td>${pd.CONCEPT_ORG }</td>
									<td>${pd_new.DISTRICT}<c:if test="${pd_new.OP_TYPE<=1 }"><span class="edit" onclick="setInput(this,'DISTRICT','${pd_new.DISTRICT}');"></span></c:if></td>
								</tr>
								<tr>
									<td align="right">来源-给药途径名称_中文：</td>
									<td>${pd.ORG_DR_CHN }</td>
								...
								<tr>
									<td align="right">来源-给药途径名称_英文：</td>
									<td>${pd.ORG_DR_ENG }</td>
								...
								<tr>
									<td align="right">来源-给药途径名称_英文缩写：</td>
									<td>${pd.ORG_DR_CHN_ABB }</td>
									<td>${pd_new.ORG_FAC_ABB}<c:if test="${pd_new.OP_TYPE<=1 }"><span class="edit" onclick="setInput(this,'ORG_FAC_ABB','${pd_new.ORG_FAC_ABB}');"></span></c:if></td>
								</tr>
								<tr>
									<td align="right">来源-标准给药途径名称_中文：</td>
									<td>${pd.ORG_STAD_DR_CHN }</td>
									<td>${pd_new.ORG_STAD_CHN}</td>
								</tr>
								<tr>
									<td align="right">来源-标准给药途径名称_英文：</td>
									<td>${pd.ORG_STAD_DR_ENG }</td>
