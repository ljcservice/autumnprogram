			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<div id="zhongxin" style="padding-top: 13px;height: 450px;overflow: auto;">
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									<td align="left">
									<c:if test="${pd_new.OP_TYPE==0 }">新增药品生产企业</c:if>
									<c:if test="${pd_new.OP_TYPE==1 }">修改药品生产企业</c:if>
									<c:if test="${pd_new.OP_TYPE==4 }">停用药品生产企业</c:if>
									：<b/>
									</td>
							...
							<tbody id="standTbody" align="center">
								<tr>
									<td align="right">生产企业名称_中文</td>
									<td>${pd.FAC_CHN }</td>
									<td>${pd_new.DN_CHN}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'DN_CHN','${pd_new.DN_CHN}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">生产企业名称_英文</td>
									<td>${pd.FAC_ENG }</td>
									<td>${pd_new.DN_ENG}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'DN_ENG','${pd_new.DN_ENG}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">生产企业名称_简称</td>
									<td>${pd.FAC_ABB }</td>
									<td>${pd_new.FAC_ABB}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.FAC_ABB}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">药品标准生产企业名称_中文</td>
									<td>${pd.STAD_FAC_CHN }</td>
									<td>${pd_new.STAD_CHN}</td>
								</tr>
								<tr>
									<td align="right">药品标准生产企业名称_英文</td>
									<td>${pd.STAD_FAC_ENG }</td>
									<td>${pd_new.STAD_ENG}</td>
								</tr>
								<tr>
									<td align="right">药品标准生产企业名称_简称</td>
									<td>${pd.STAD_FAC_ABB }</td>
									<td>${pd_new.STAD_FAC_ABB}</td>
								</tr>
								<tr>
									<td align="right">来源-生产企业名称_中文</td>
									<td>${pd.ORG_FAC_CHN }</td>
									<td>${pd_new.ORG_DN_CHN}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.ORG_DN_CHN}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">来源-生产企业名称_英文</td>
									<td>${pd.ORG_FAC_ENG }</td>
									<td>${pd_new.ORG_DN_ENG}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.ORG_DN_ENG}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">来源-药品标准生产企业名称_中文</td>
									<td>${pd.ORG_STAD_FAC_CHN }</td>
									<td>${pd_new.ORG_STAD_CHN}</td>
								</tr>
								<tr>
									<td align="right">来源-药品标准生产企业名称_英文</td>
									<td>${pd.ORG_STAD_FAC_ENG }</td>
									<td>${pd_new.ORG_STAD_ENG}</td>
								</tr>
								<tr>
									<td align="right">来源-生产企业名称_简称</td>
									<td>${pd.ORG_FAC_ABB }</td>
									<td>${pd_new.ORG_FAC_ABB}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.ORG_FAC_ABB}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">来源-药品标准生产企业名称_简称</td>
									<td>${pd.ORG_STAD_FAC_ABB }</td>
									<td>${pd_new.ORG_STAD_FAC_ABB}</td>
								</tr>
								<tr>
									<td align="right">国家</td>
									<td>${pd.COUNTRY }</td>
									<td>${pd_new.COUNTRY}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.COUNTRY}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">地区</td>
									<td>${pd.AREA }</td>
									<td>${pd_new.DISTRICT}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.DISTRICT}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">区号</td>
									<td>${pd.AREA_CODE }</td>
									<td>${pd_new.AREA_CODE}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.AREA_CODE}');"/></c:if></td>
								</tr>
								<tr>
									<td align="right">备注</td>
									<td>${pd.REMARK }</td>
									<td>${pd_new.DRUG_MEMO}<c:if test="${pd_new.OP_TYPE <=1}"><span class="edit" onclick="setInput(this,'FAC_ABB','${pd_new.DRUG_MEMO}');"/></c:if></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>${pd_new.DESCRIPTION}<c:if test="${pd_new.OP_TYPE <=1||pd_new.OP_TYPE==4}"><span class="edit" onclick="setInput(this,'DESCRIPTION','${pd_new.DESCRIPTION}');"/></c:if></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td colspan="2">
										<input type="text" name="CHECK_MEMO" style="width: 98%;"/>
									</td>
								</tr>
								<tr id="showConsol">
...
function checkData(){
	...
	if(DN_CHN!=null){
		if(DN_CHN.value ==null || DN_CHN.value=="" ){
			$(DN_CHN).tips({ side:3, msg:'请输入生产企业中文名', bg:'#AE81FF',  time:3   });
			flag = false;
		}
	...
	if(DN_ENG!=null){
		if(DN_ENG.value ==null || DN_ENG.value=="" ){
			$(DN_ENG).tips({ side:3, msg:'请输入生产企业英文名', bg:'#AE81FF',  time:3   });
			flag = false;
		}
	}
