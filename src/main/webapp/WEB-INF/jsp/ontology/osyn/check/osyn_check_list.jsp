						...
						<div class="col-xs-12">
							...
							<table style="margin-top:5px;">
								<tr>
									<td style="padding-left:2px;padding-right:8px;padding-top:5px;">
										<div class="nav-search">
											<span class="input-icon" style="float: left;">
												<input class="nav-search-input" autocomplete="off" id="DN_NAME" maxlength="255" type="text" name="DN_NAME" value="${pd.DN_NAME }" placeholder="名称/编码等" style="width: 130px;" />
									...
									<td style="vertical-align:top;padding-left:2px;padding-right:8px;" nowrap>
										术语类别：
									 	<select class="chosen-select form-control" name="onto_type" id="onto_type" data-placeholder="词语类型" style="vertical-align:top;width: 150px;">
									...
									<td style="vertical-align:top;padding-left:2px;padding-right:8px;padding-top:5px;" nowrap>
										操作类型：
									 	<select class="chosen-select form-control" name="OP_TYPE" id="OP_TYPE" data-placeholder="操作类型" style="vertical-align:top;width: 100px;">
											<option value=""></option>
											<option value="" <c:if test="${pd.OP_TYPE==null || pd.OP_TYPE==''}">selected</c:if>></option>
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<thead>
									<tr>
										...
										<th class="center">术语名称中文</th>
										<th class="center">术语名称英文</th>
										<th class="center">术语规范名称中文</th>
										<th class="center">术语规范名称英文</th>
										<th class="center">来源-术语名称-中文</th>
										...
										<c:when test="${not empty list}">
											<c:forEach items="${list}" var ="osyn" varStatus="vs">
												<tr>
													...
													<td class='center'>${osyn.STAND_CHN_NAME}</td>
													<td class='center'>${osyn.STAND_ENG_NAME}</td>
													...
													<td class="center">
														<c:if test="${osyn.STATUS==0}">审核中</c:if>
