						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center" nowrap>标准术语名称</th>
									...
									<c:forEach items="${resultList}" var="diag" varStatus="vs">
										...
										<tr>
											<td class='center' style="width: 30px;">
												<input type="radio" name='standIs' value="${diag.ON_ID}" CN="${diag.ON_CHN}" EN="${diag.ON_ENG}" O_CN="${diag.ORG_ON_CN}" O_EN="${diag.ORG_ON_EN}"/>
											</td>
											<td class="center">${diag.ON_CHN}</td>
											<td class="center">${diag.STANDARD_NAME}</td>
											<td class="center">${diag.ON_ENG}</td>
											<td class="center">${diag.ORG_ON_CHN}</td>
											<td class="center">${diag.ORG_ON_ENG}</td>
