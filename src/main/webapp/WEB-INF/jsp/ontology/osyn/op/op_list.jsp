					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;;">
								<thead>
									<tr>
										<th class="center" width="15%">手术名称中文</th>
										<th class="center" width="15%">标准手术名称</th>
										<th class="center" width="15%">手术名称英文</th>
										<th class="center" width="10%">同义词类型</th>
										<th class="center" width="10%">停用标记</th>
										<th class="center" width="10%">更新人</th>
										<th class="center" width="10%">更新时间</th>
										<th class="center" width="15%">来源-手术名称中文</th>
									</tr>
								</thead>
								<tbody>
									<!-- 列表循环开始 -->
									<c:choose>
										<c:when test="${not empty osynList}">
											<c:forEach items="${osynList}" var ="osyn" varStatus="vs">
												<tr id="${osyn.ON_ID }" edit_flag="${osyn.OSYN_EDIT_FLAG }">
													<td class='center' <c:if test="${osyn.OSYN_EDIT_FLAG==1}"> style="color: #ffb752" title="审核中" </c:if> style="word-break:break-all">${osyn.ON_CHN}</td>
													<td class='center'>${osyn.STANDARD_NAME}</td>
													<td class='center' style="word-break:break-all;">${osyn.ON_ENG}</td>
													<td class='center'>
													...
													<td class='center'>${osyn.ORG_ON_CHN}</td>
