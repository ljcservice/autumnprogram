						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center" nowrap>剂型名称中文</th>
									<th class="center" nowrap>标准剂型名称中文</th>
									<th class="center" nowrap>剂型名称英文</th>
									<th class="center" nowrap>来源-剂型中文</th>
									<th class="center" nowrap>来源-剂型英文</th>
									...
									<c:forEach items="${resultList}" var="drug" varStatus="vs">
										<tr>
											<td class='center' style="width: 30px;">
												<input type="radio" name='standIs' value="${drug.F_ID}" CN="${drug.F_CHN_NAME}" EN="${drug.F_ENG_NAME}" O_CN="${drug.ORG_DOS_CHN}" O_EN="${drug.ORG_DOS_ENG}"/>
											</td>
											<td class="center">${drug.F_CHN_NAME}</td>
											<td class="center">${drug.STAD_DOS_CHN}</td>
											<td class="center">${drug.F_ENG_NAME}</td>
											<td class="center">${drug.ORG_DOS_CHN}</td>
											<td class="center">${drug.ORG_DOS_ENG}</td>
