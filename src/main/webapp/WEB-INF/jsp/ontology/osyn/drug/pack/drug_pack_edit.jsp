					...
					<div class="row">
						<div class="col-xs-12">
								<form action="osyn/saveDiagOsyn.do" name="diagOsynForm" id="diagOsynForm" method="post">
									...
									<input type="hidden" name="DN_ID" id="DN_ID" value="${pd.DP_ID }"/>
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											<td style="width:130px;text-align: right;padding-top: 13px;">包装材质中文:</td>
											<td><input type="text" name="DN_CHN" id="DN_CHN" maxlength="255" placeholder="输入包装材质中文" onblur="checkName(this,'DN_CHN');" value="${pd.DP_CHN }" style="width:98%;"/></td>
											<td width="19%" style="width:130px;text-align: right;padding-top: 13px;">来源包装材质中文:</td>
											<td width="31%">
												<input type="text" name="ORG_DN_CHN" id="ORG_DN_CHN"  value="${pd.ORG_DP_CHN }"  maxlength="255" placeholder="输入来源包装材质中文" style="width:98%;"/>
											</td>
										</tr>
										<tr>
											<td style="width:130px;text-align: right;padding-top: 13px;">包装材质英文:</td>
											<td><input type="text" name="DN_ENG" id="DN_ENG"  maxlength="255" placeholder="包装材质英文" value="${pd.DP_ENG }" style="width:98%;"/></td>
											<td style="width:130px;text-align: right;padding-top: 13px;">来源包装材质英文:</td>
											<td><input type="text" name="ORG_DN_ENG" id="ORG_DN_ENG"  maxlength="255" placeholder="输入来源包装材质英文" value="${pd.ORG_DP_ENG }" style="width:98%;"/></td>
													<input type="hidden" name="STAD_DN_ID" id="STAD_DN_ID"  value="${pd.STAD_DP_ID }"  maxlength="255" style="width:70%;"/><!-- 标准名称ID -->
										</tr>
										<!-- 若新增的词语为同义词，则需要获取以下信息 -->
										<tr id="stad1">
											<td style="width:130px;text-align: right;padding-top: 13px;">药品标准包装材质中文:</td>
											<td>
												<input type="text" name="STAD_CHN" id="STAD_CHN"  value="${pd.STAD_DP_CHN }"  maxlength="255" placeholder="选择术语规范名称" style="width:85%;" readonly/>
												<a onclick="selectDiag();">选择</a>	
											</td>
											<td style="width:130px;text-align: right;padding-top: 13px;">来源标准药品包装材质中文:</td>
											<td><input type="text" name="ORG_STAD_CHN" id="ORG_STAD_CHN" value="${pd.ORG_STAD_DP_CHN }" placeholder="来源标准药品包装材质中文" maxlength="255" style="width:98%;" readonly/></td>
										</tr>
										<tr id="stad2">
											<td style="width:130px;text-align: right;padding-top: 13px;">药品标准包装材质英文:</td>
											<td>
												<input type="text" name="STAD_ENG" id="STAD_ENG"  value="${pd.STAD_DP_ENG }" maxlength="255" placeholder="药品标准包装材质英文" style="width:98%;" readonly/>
											</td>
											<td style="width:130px;text-align: right;padding-top: 13px;">来源标准药品包装材质英文:</td>
											<td>
												<input type="text" name="ORG_STAD_ENG" id="ORG_STAD_ENG"  value="${pd.ORG_STAD_DP_ENG }" maxlength="255" placeholder="来源标准药品包装材质英文" style="width:98%;" readonly/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											<td style="text-align: center;" colspan="10">
												<c:if test="${MSG=='saveDiagOsyn'}">
													...
													<input type="hidden" name="UPD_DESC" value="新增药品包装材质信息"/>
												...
												<c:if test="${MSG=='edit'}">
													...
													<a class="btn btn-mini btn-primary" onclick="searchHist('${pd.DP_ID}','${pd.termCategory}');">查看历史变更记录</a>
												</c:if>
	...
	function checkData(){
		...
		if($("input[name='WORD_TYPE']:checked").val()==0){
			if($("#STAD_CHN").val()==null || $.trim($("input[name='IS_DISABLE']:checked").val())==""){
				$("#STAD_CHN").tips({ side:3, msg:'请选择标准药品包装材质', bg:'#AE81FF',  time:3   });
			}
		}
		return flag;
	}
