						...
						<div class="col-xs-12">
							...
							<table style="margin-top:5px;">
								<tr>
									<td style="vertical-align:top;padding-left:12px;padding-right:2px;">
										<div class="nav-search" style="float: left;">
											<span class="input-icon">
												<input class="nav-search-input" autocomplete="off" id="DN_NAME" type="text" name="DN_NAME" value="${pd.DN_NAME }" placeholder="名称/编码等" style="width: 140px;" />
									...
									<td style="vertical-align:top;padding-left:12px;padding-right:2px;" nowrap>
										术语类别：
									 	<select class="chosen-select form-control" name="termCategory" id="termCategory" data-placeholder="排序方式" style="vertical-align:top;width: 150px;">
									 		<option value=""></option>
								...
								<tr>
									...
									<td style="vertical-align:top;padding-left:12px;padding-right:12px;padding-top: 5px;">
										排列方式：
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<thead>
									<tr>
										...
										<th class="center">药品标准规格</th>
										<th class="center">来源药品规格</th>
										<th class="center">来源药品标准规格</th>
									...
									<c:choose>
										<c:when test="${not empty osynList}">
											<c:forEach items="${osynList}" var ="osyn" varStatus="vs">
												<tr id="${osyn.SP_ID }" edit_flag="${osyn.OSYN_EDIT_FLAG }">
													<td class='center' <c:if test="${osyn.OSYN_EDIT_FLAG==1}"> style="color: #ffb752" title="审核中" </c:if>>${osyn.DRUG_SP }</td>
													<td class='center'>${osyn.DRUG_STAD}</td>
													<td class='center'>${osyn.ORG_DRUG_SP}</td>
													<td class='center'>${osyn.ORG_DRUG_STAD_SP}</td>
													<td class='center'>
													...
													<td class='center'>${osyn.REMARK}</td>
												</tr>
											</c:forEach>
										</c:when>
										<c:otherwise>
