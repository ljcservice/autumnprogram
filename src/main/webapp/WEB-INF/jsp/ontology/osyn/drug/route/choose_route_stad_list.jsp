						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center" nowrap>给药途径中文</th>
									<th class="center" nowrap>术语给药途径中文</th>
									<th class="center" nowrap>给药途径英文</th>
									<th class="center" nowrap>给药途径-英文简称</th>
									<th class="center" nowrap>来源-给药途径-中文</th>
									<th class="center" nowrap>来源-给药途径-英文</th>
									...
									<c:forEach items="${resultList}" var="drug" varStatus="vs">
										<tr>
											<td class='center' style="width: 30px;">
												<input type="radio" name='standIs' value="${drug.DR_ID}" CN="${drug.DR_CHN}" EN="${drug.DR_ENG}" O_CN="${drug.ORG_DR_CHN}" O_EN="${drug.ORG_DR_ENG}"/>
											</td>
											<td class="center">${drug.DR_CHN}</td>
											<td class="center">${drug.STAD_DR_CHN}</td>
											<td class="center">${drug.DR_ENG}</td>
											<td class="center">${drug.DR_ENG_ABB}</td>
											<td class="center">${drug.ORG_DR_CHN}</td>
											<td class="center">${drug.ORG_DR_ENG}</td>
