					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<thead>
									<tr>
										<th class="center">给药途径名称中文</th>
										<th class="center">标准给药途径名称_中文</th>
										<th class="center">给药途径名称英文</th>
										<th class="center">名称英文缩写</th>
										<th class="center">概念</th>
										<th class="center">来源-给药途径名称_中文</th>
										<th class="center">来源-给药途径名称_英文</th>
									...
									<c:choose>
										<c:when test="${not empty osynList}">
											<c:forEach items="${osynList}" var ="osyn" varStatus="vs">
												<tr id="${osyn.dr_id }" edit_flag="${osyn.OSYN_EDIT_FLAG }">
													<td class='center' <c:if test="${osyn.OSYN_EDIT_FLAG==1}"> style="color: #ffb752" title="审核中" </c:if>>${osyn.DR_CHN }</td>
													<td class='center'>${osyn.STAD_DR_CHN}</td>
													<td class='center'>${osyn.DR_ENG}</td>
													<td class='center'>${osyn.DR_ENG_ABB}</td>
													<td class='center'>${osyn.CONCEPT}</td>
													<td class='center'>${osyn.ORG_DR_CHN}</td>
													<td class='center'>${osyn.ORG_DR_ENG}</td>
													<td class='center'>
