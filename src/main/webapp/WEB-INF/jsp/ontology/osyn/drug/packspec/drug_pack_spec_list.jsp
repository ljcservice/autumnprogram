					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table style="margin-top:5px;">
								...
								<tr>
									<td style="vertical-align:top;padding-left:2px;padding-right:2px;padding-top: 5px;" nowrap>
										是否停用：
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<thead>
									<tr>
										<th class="center">药品包装规格中文</th>
										<th class="center">药品标准包装规格</th>
										<th class="center">药品标准规格单位</th>
										<th class="center">药品包装规格英文</th>
										<th class="center">来源药品包装规格中文</th>
										<th class="center">来源药品包装规格英文</th>
									...
									<c:choose>
										<c:when test="${not empty osynList}">
											<c:forEach items="${osynList}" var ="osyn" varStatus="vs">
												<tr id="${osyn.PS_ID }" edit_flag="${osyn.OSYN_EDIT_FLAG }">
													<td class='center' <c:if test="${osyn.OSYN_EDIT_FLAG==1}"> style="color: #ffb752" title="审核中" </c:if>>${osyn.PS_CHN }</td>
													<td class='center'>${osyn.STAD_PS_CHN}</td>
													<td class='center'>${osyn.STAD_PS_UNIT_CHN}</td>
													<td class='center'>${osyn.PS_ENG}</td>
													<td class='center'>${osyn.ORG_PS_CHN}</td>
													<td class='center'>${osyn.ORG_PS_ENG}</td>
													<td class='center'>
