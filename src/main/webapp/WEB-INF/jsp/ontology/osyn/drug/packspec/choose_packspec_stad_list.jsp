						...
						<div id="zhongxin" style="padding-top: 13px;">
							...
							<table style="margin-top:5px;">
								<tr>
									...
									<td style="vertical-align:top;padding-left:5px;"><a class="btn btn-light btn-xs" onclick="searchs(this);"  title="检索"><i id="nav-search-icon" class="ace-icon fa fa-search bigger-110 nav-search-icon blue"></i></a></td>
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center" nowrap>药品包装规格中文</th>
									<th class="center" nowrap>标准药品包装规格中文</th>
									<th class="center" nowrap>药品包装规格英文</th>
									<th class="center" nowrap>来源药品包装规格中文</th>
									<th class="center" nowrap>来源药品包装规格英文</th>
									...
									<c:forEach items="${resultList}" var="drug" varStatus="vs">
										...
										<tr>
											<td class='center' style="width: 30px;">
												<input type="radio" name='standIs' value="${drug.PS_ID}" CN="${drug.PS_CHN}" EN="${drug.PS_ENG}" O_CN="${drug.ORG_PS_CHN}" O_EN="${drug.ORG_PS_ENG}" S_VC="${drug.STAD_PS_VALUE_CHN}" S_VE="${drug.STAD_PS_VALUE_ENG}" S_UC="${drug.STAD_PS_UNIT_CHN }" S_UE="${drug.STAD_PS_UNIT_ENG }" P_SU="${drug.PSU_ID }"/>
											</td>
											<td class="center">${drug.PS_CHN}</td>
											<td class="center">${drug.STAD_PS_CHN}</td>
											<td class="center">${drug.PS_ENG}</td>
											<td class="center">${drug.ORG_PS_CHN}</td>
											<td class="center">${drug.ORG_PS_ENG}</td>
...
function selectCont(){
	...
	mydocument.getElementById("STAD_PACK_SPEC_CHN").value = osyn.attr("S_VC");
	mydocument.getElementById("STAD_PACK_SPEC_ENG").value = osyn.attr("S_VE");
	mydocument.getElementById("STAD_PACK_SPEC_UNIT_CHN").value = osyn.attr("S_UC");
	mydocument.getElementById("STAD_PACK_SPEC_UNIT_ENG").value = osyn.attr("S_UE");
	mydocument.getElementById("PSU_ID").value = osyn.attr("P_SU");
	ownerDialog.close();
}
