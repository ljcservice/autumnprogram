						...
						<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
							<thead>
								<tr>
									...
									<th class="center" nowrap>包装材质中文</th>
									<th class="center" nowrap>药品标准包装材质中文</th>
									<th class="center" nowrap>包装材质英文</th>
									<th class="center" nowrap>来源包装材质中文</th>
									<th class="center" nowrap>来源包装材质英文</th>
									...
									<c:forEach items="${resultList}" var="drug" varStatus="vs">
										...
										<tr>
											<td class='center' style="width: 30px;">
												<input type="radio" name='standIs' value="${drug.DP_ID}" CN="${drug.DP_CHN}" EN="${drug.DP_ENG}" O_CN="${drug.ORG_DP_CHN}" O_EN="${drug.ORG_DP_ENG}"/>
											</td>
											<td class="center">${drug.DP_CHN}</td>
											<td class="center">${drug.STAD_DP_CHN}</td>
											<td class="center">${drug.DP_ENG}</td>
											<td class="center">${drug.ORG_STAD_DP_CHN}</td>
											<td class="center">${drug.ORG_STAD_DP_ENG}</td>
