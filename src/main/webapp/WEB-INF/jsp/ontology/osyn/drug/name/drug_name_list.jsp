							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<thead>
									<tr>
										...
										<th class="center">药品中文名</th>
										<th class="center">药品英文名</th>
										<th class="center">药品标准中文名</th>
										<th class="center">药品标准英文名</th>
										<th class="center">来源药品中文名</th>
										...
										<c:when test="${not empty osynList}">
											<c:forEach items="${osynList}" var ="osyn" varStatus="vs">
												<tr id="${osyn.dn_id }" edit_flag="${osyn.OSYN_EDIT_FLAG }">
													<td class='center' <c:if test="${osyn.OSYN_EDIT_FLAG==1}"> style="color: #ffb752" title="审核中" </c:if>>${osyn.CHN_NAME }</td>
													<td class='center'>${osyn.ENG_NAME}</td>
													<td class='center'>${osyn.STAD_CHN_NAME}</td>
													<td class='center'>${osyn.STAD_ENG_NAME}</td>
													<td class='center'>${osyn.ORG_CHN_NAME}</td>
													<td class='center'>
