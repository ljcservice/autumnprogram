					...
					<div class="row">
						<div class="col-xs-12">
							...
							<table style="margin-top:5px;">
								<tr>
									<td style="vertical-align:top;padding-left:12px;padding-right:2px;">
									...
									<td style="vertical-align:top;padding-left:12px;padding-right:2px;" nowrap>
										术语类别：
									 	<select class="chosen-select form-control" name="termCategory" id="termCategory" style="vertical-align:top;width: 120px;">
									 		<option value=""></option>
									...
									<td style="padding-left:12px;padding-right:12px;padding-top: 5px;" nowrap>
										更 新&nbsp;&nbsp;人 ：
								...
								<tr>
									<td style="vertical-align:top;padding-left:12px;padding-right:12px;padding-top: 5px;" nowrap>
										是否停用：
									...
									<td style="padding-left:12px;padding-right:12px;padding-top: 5px;">
										排列方式：
										<select class="chosen-select form-control" name="CONDITION" id="CONDITION" data-placeholder="排序" style="vertical-align:top;width: 120px;">
											<option value=""></option>
											<option value="1" <c:if test="${pd.CONDITION=='1'}">selected</c:if>>按更新时间正序排列</option>
											<option value="2" <c:if test="${pd.CONDITION=='2'}">selected</c:if>>按更新时间倒序排列</option>
										</select>
									</td>
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<thead>
									<tr>
										...
										<th class="center">药品规格单位中文</th>
										<th class="center">药品标准规格单位</th>
										<th class="center">药品规格单位英文</th>
										<th class="center">来源药品规格单位中文</th>
										<th class="center">来源药品规格单位英文</th>
									...
									<c:choose>
										<c:when test="${not empty osynList}">
											<c:forEach items="${osynList}" var ="osyn" varStatus="vs">
												<tr id="${osyn.PSU_ID }" edit_flag="${osyn.OSYN_EDIT_FLAG }">
													<td class='center' <c:if test="${osyn.OSYN_EDIT_FLAG==1}"> style="color: #ffb752" title="审核中" </c:if>>${osyn.PSU_CHN }</td>
													<td class='center'>${osyn.PSU_STAD_CHN}</td>
													<td class='center'>${osyn.PSU_ENG}</td>
													<td class='center'>${osyn.ORG_PSU_CHN}</td>
													<td class='center'>${osyn.ORG_PSU_ENG}</td>
													<td class='center'>
