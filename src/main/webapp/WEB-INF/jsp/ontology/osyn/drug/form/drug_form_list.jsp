							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<thead>
									<tr>
										...
										<th class="center">药品剂型中文</th>
										<th class="center">药品剂型英文</th>
										<th class="center">药品标准剂型中文</th>
										<th class="center">药品标准剂型英文</th>
										<th class="center">来源药品剂型中文</th>
										<th class="center">来源药品剂型英文</th>
									...
									<c:choose>
										<c:when test="${not empty osynList}">
											<c:forEach items="${osynList}" var ="osyn" varStatus="vs">
												<tr id="${osyn.f_id }" edit_flag="${osyn.OSYN_EDIT_FLAG }">
													<td class='center' <c:if test="${osyn.OSYN_EDIT_FLAG==1}"> style="color: #ffb752" title="审核中" </c:if>>${osyn.F_CHN_NAME }</td>
													<td class='center'>${osyn.F_ENG_NAME}</td>
													<td class='center'>${osyn.STAD_DOS_CHN}</td>
													<td class='center'>${osyn.STAD_DOS_ENG}</td>
													<td class='center'>${osyn.ORG_DOS_CHN}</td>
													<td class='center'>${osyn.ORG_DOS_ENG}</td>
													<td class='center'>
