							...
							<table style="margin-top:5px;">
								<tr>
									...
									<td style="vertical-align:top;padding-left:12px;padding-right:2px;" nowrap> 
										查询类型：
									 	<select class="chosen-select form-control" name="wordType" id="wordType" data-placeholder="" style="vertical-align:top;width: 100px;" onchange="changeWord();">
											<option value=""></option>
									...
									<td style="padding-left:12px;padding-right:2px;vertical-align:top;" nowrap>
										更 新&nbsp;&nbsp;人 ：
								...
								<tr>
									...
									<td style="vertical-align:top;padding-left:12px;padding-right:2px;padding-top: 5px;">
										排列方式：
										<select class="chosen-select form-control" name="CONDITION" id="CONDITION" data-placeholder="排序" style="vertical-align:top;width: 100px;">
											<option value=""></option>
							...
							<table id="simple-table" class="table table-striped table-bordered table-hover"  style="margin-top:5px;">
								<thead>
									<tr>
										...
										<th class="center">包装材质中文</th>
										<th class="center">药品标准包装材质中文</th>
										<th class="center">包装材质英文</th>
										<th class="center">来源包装材质中文</th>
										<th class="center">来源包装材质英文</th>
									...
									<c:choose>
										<c:when test="${not empty osynList}">
											<c:forEach items="${osynList}" var ="osyn" varStatus="vs">
												<tr id="${osyn.DP_ID }" edit_flag="${osyn.OSYN_EDIT_FLAG }">
													<td class='center' <c:if test="${osyn.OSYN_EDIT_FLAG==1}"> style="color: #ffb752" title="审核中" </c:if>>${osyn.DP_CHN }</td>
													<td class='center'>${osyn.STAD_DP_CHN}</td>
													<td class='center'>${osyn.DP_ENG}</td>
													<td class='center'>${osyn.ORG_DP_CHN}</td>
													<td class='center'>${osyn.ORG_DP_ENG}</td>
													<td class='center'>
