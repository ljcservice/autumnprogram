								...
								<form action="osyn/saveDiagOsyn.do" name="diagOsynForm" id="diagOsynForm" method="post">
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										...
										<tr>
											...
											<td><input type="text" name="DN_CHN" id="DN_CHN" maxlength="255" placeholder="输入术语名称中文" value="${pd.DN_CHN }" onblur="checkName(this,'DN_CHN');" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">术语名称-英文:</td>
											<td><input type="text" name="DN_ENG" id="DN_ENG"  maxlength="255" placeholder="输入术语名称英文" value="${pd.DN_ENG }" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">术语规范名称:</td>
											<td><input type="hidden" name="STAD_DN_ID" id="STAD_DN_ID"  value="${pd.STAD_DN_ID }"  maxlength="50" style="width:70%;"/>
												<input type="text" name="SHOW_NAME" id="SHOW_NAME"  value="${pd.STANDARD_NAME }"  maxlength="255" placeholder="这里输入术语规范名称" style="width:90%;"/>
												<a id="selectStad" onclick="selectDiag();">选择</a>
											</td>
										</tr>
										<!-- 
										<tr id="stad2">
											<td style="width:79px;text-align: right;padding-top: 13px;">术语类型:</td>
											<td>
												<select name="TERM_TYPE" id="TERM_TYPE" data-placeholder="术语类型" style="width:98%;">
													<option value=""></option>
													<option value="1" <c:if test="${pd.TERM_TYPE==1 ||pd.TERM_TYPE==null}">selected</c:if>>症状</option>
										...
										<tr>
											...
											<td><input type="text" name="ORG_DN_CHN" id="ORG_DN_CHN" value="${pd.ORG_DN_CHN }" placeholder="输入术语来源名称-中文" maxlength="255" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">术语来源名称-英文:</td>
											<td>
												<input type="text" name="ORG_DN_ENG" id="ORG_DN_ENG"  value="${pd.ORG_DN_ENG }" maxlength="255" placeholder="输入术语来源名称-英文" onblur="hasE('${pd.USERNAME }')" style="width:98%;"/>
											</td>
										</tr>
										<tr>
