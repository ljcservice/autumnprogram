					...
					<div class="row">
						<div class="col-xs-12" >
							<div id="searchDiv"  style="vertical-align:bottom;float: left;padding-top: 4px;padding-bottom: 5px;width: 100%;">
								<form name="searchForm" id="searchForm" action="InHospitalRep/DRANO012.do" method="post" > 
...
<!-- 									</div> -->
							...
							<thead>
								<tr>
									...
									<th class="center" nowrap>静脉输液例数</th>
									<th class="center" nowrap>静脉输液使用率</th>
									<th class="center" nowrap>抗菌药物静脉输液例数</th>
									<th class="center" nowrap>抗菌药物静脉输液占比</th>
								</tr>
							</thead>
							<tbody>
								...
								<c:when test="${not empty patinfos}">
									<c:forEach items="${patinfos}" var="patVisit" varStatus="vs" >
										...
										<tr ondblclick="">
											...
											<td nowrap class="center">${patVisit.adminjmsysum }</td>
											<td nowrap class="center">
												${patVisit.adminjmsysum}/${patVisit.pat_count}*100=
												<fmt:formatNumber value="${patVisit.intensity}" type="number" maxFractionDigits="2" ></fmt:formatNumber>%
											</td>
											<td nowrap class="center">${patVisit.adminantijmsysum }</td>
											<td nowrap class="center">
												${patVisit.adminantijmsysum}/${patVisit.adminjmsysum}*100=
												<fmt:formatNumber value="${patVisit.intensityanti}" type="number" maxFractionDigits="2" ></fmt:formatNumber>%
											</td>
										</tr>
									</c:forEach>  
								</c:when>
							...
							<tfoot>
								<tr  style="background-color:orange;">
									<td nowrap class="center" style="width:30px;" rowspan="2" colspan="2">总计</td>
									<td nowrap class="center">总出院人数</td>
									<td nowrap class="center">转科人数</td>
									<td nowrap class="center">静脉输液例数</td>
									<td nowrap class="center">静脉输液使用率</td>
									<td nowrap class="center">抗菌药物静脉输液例数</td>
									<td nowrap class="center">抗菌药物静脉输液占比</td>
								</tr>
								<c:if test="${not empty patinfosum }">
									<tr style="background-color:orange;" >
										<td nowrap class="center">${patinfosum.pat_count } </td>
										<td nowrap class="center">${patinfosum.scd }</td>
										<td nowrap class="center">${patinfosum.adminjmsysum }</td>
										<td nowrap class="center">
											${patinfosum.adminjmsysum}/${patinfosum.pat_count}*100=
											<fmt:formatNumber value="${patinfosum.intensity}" type="number" maxFractionDigits="2" />%
										</td>
										<td nowrap class="center">${patinfosum.adminantijmsysum }</td>
										<td nowrap class="center">
											${patinfosum.adminantijmsysum}/${patinfosum.adminjmsysum}*100=
											<fmt:formatNumber value="${patinfosum.intensityanti}" type="number" maxFractionDigits="2" />%
										</td>
									</tr>
								</c:if>
							</tfoot>
