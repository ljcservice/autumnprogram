...
<!-- 									</div> -->
							...
							<thead>
								<tr>
									...
									<th class="center" nowrap>病人</th>
									<th class="center" nowrap>医生</th>
									<th class="center" nowrap>当前科室住院天数</th>
									<th class="center" nowrap>DDD值</th>
									<th class="center" nowrap>DDD强度</th>
									<th class="center" nowrap>限制级DDD值</th>
									<th class="center" nowrap>限制级强度</th>
									<th class="center" nowrap>特殊级DDD值</th>
								...
								<c:when test="${not empty patinfos}">
									<c:forEach items="${patinfos}" var="patVisit" varStatus="vs" >
										...
										<tr ondblclick="">
											...
											<td nowrap class="center">
												<fmt:formatNumber value="${patVisit.limit_ddd_value }" type="number" maxFractionDigits="2"></fmt:formatNumber>
											</td>  
...
function listExport(){
	window.open(path + "/InHospitalRep/DRANO003Export.do?"+$("#searchForm").serialize());
}
function myprint(){
	$("#main-container").hide();
