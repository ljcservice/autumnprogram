					...
					<div class="row">
						<div class="col-xs-12" >
							<div id="searchDiv"  style="vertical-align:bottom;float: left;padding-top: 4px;padding-bottom: 5px;width: 100%;">
								<form name="searchForm" id="searchForm" action="InHospitalRep/DRANO001.do" method="post" > 
								...
								<c:when test="${not empty patinfos}">
									<c:forEach items="${patinfos}" var="patVisit" varStatus="vs" >
										...
										<tr ondblclick="">
											...
											<td nowrap class="center"> <fmt:formatNumber value="${patVisit.ddd_values }" type="number" maxFractionDigits="2"></fmt:formatNumber> </td>
											<td nowrap class="center"><fmt:formatNumber value="${patVisit.intensity }" type="number" maxFractionDigits="2"></fmt:formatNumber></td>  
...
function listExport(){
	window.open(path + "/InHospitalRep/DRANO001Export.do?"+$("#searchForm").serialize());
}
function myprint(){
	$("#main-container").hide();
