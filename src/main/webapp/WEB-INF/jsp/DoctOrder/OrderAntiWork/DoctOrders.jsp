...
<!-- 									药品类型 begin -->
									<div class="btn-group">
										<button data-toggle="dropdown" class="btn btn-sm btn-danger">
											<span id="resetDrugTypeSpan" >
												${page.pd.drug_type_name != null && page.pd.drug_type_name !=''?page.pd.drug_type_name:"药品种类"}
											</span>
											<span class="ace-icon fa fa-angle-down icon-only"></span>
										</button>
										<ul class="dropdown-menu dropdown-danger">
											<li>
												<a href="javascript:drug_type('','全部药品');">全部药品</a>
											</li>
											<li>
												<a href="javascript:drug_type('HASKJ','抗菌药');">抗菌药</a>
											</li>
											<li>
												<a href="javascript:drug_type('HASZS','注射药');">注射药</a>
											</li>
											<li>
												<a href="javascript:drug_type('YLJSY','一类精神药');">一类精神药</a>
											</li>
											<li>
												<a href="javascript:drug_type('ELJSY','二类精神药');">二类精神药</a>
											</li>
											<li>
												<a href="javascript:drug_type('DDRUG','毒性药');">毒性药</a>
											</li>
											<li>
												<a href="javascript:drug_type('MDRUG','麻药');">麻药</a>
											</li>
											<li>
												<a href="javascript:drug_type('DMDRUG','毒麻药');">毒麻药</a>
											</li>
											<li>
												<a href="javascript:drug_type('FSDRUG','放射性药');">放射性药</a>
											</li>
											<li>
												<a href="javascript:drug_type('GZDRUG','贵重药');">贵重药</a>
											</li>
											<li class="divider"></li>
											<li>
													<a href="javascript:reSetDrugType();" id="resetDrugTypeId">
														<c:if test="${page.pd.drug_type_name != null && page.pd.drug_type_name !=''}">
															已经选中：${page.pd.drug_type_name }
														</c:if>
														<c:if test="${page.pd.drug_type_name == null || page.pd.drug_type_name ==''}">
															未选择医嘱类型
														</c:if>
...
<script type="text/javascript">
	...
	function reSetDrugType()
	{
		$("#reSetDrugTypeId").text("未选择");
		$("#reSetDrugTypeSpan").text("药品种类");
		var myform = window.document.forms[0];
		myform.drug_type.value = "";
		myform.drug_type_name.value = "";
		myform.submit();
	}
	...
	//药品种类
	function drug_type(_type,_name)
	{
		showBG();
		var myform = window.document.forms[0];
		myform.drug_type.value = _type;
		myform.drug_type_name.value = _name;
		myform.submit();
	}
	//处理医嘱类别
