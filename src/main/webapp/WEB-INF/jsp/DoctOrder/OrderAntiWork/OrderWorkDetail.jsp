...
<!-- 												</li> -->
											...
											<div class="tab-content" style="padding:2px;max-height: 220px;overflow: auto;">
												...
												<div id="orderCheck" class="tab-pane fade" style="width: 100%;min-height: 100px;">
													<iframe  name="CheckRsFrame" id="CheckRsFrame" scrolling ="auto"" frameborder="0"
														src="DoctOrderAnti/CheckRsViewUI.do?patient_id=${page.pd.patient_id}&visit_id=${page.pd.visit_id}&ngroupnum=${page.pd.ngroupnum}" style="margin:0px 0px 0px 0px;width:100%;height: 100%;">
													</iframe>
												</div>
											</div><!-- tab-content -->
										...
										<div style="">
											<iframe name="DoctFrame" id="DoctFrame" scrolling="no" frameborder="0" 
												src="DoctOrderAnti/DoctOrdersDetail.do?patient_id=${page.pd.patient_id}&visit_id=${page.pd.visit_id}&ngroupnum=${page.pd.ngroupnum}" style="margin:0 auto;width:100%;height: 100%;">
											</iframe>
										</div>
