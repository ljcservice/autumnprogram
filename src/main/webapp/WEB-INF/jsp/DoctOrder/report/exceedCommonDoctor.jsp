				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							...
							<form action="report/exceedCommonDoctor.do" method="post" name="searchForm" id="searchForm">
						...
						<div  >
							...
							<thead>
								<tr>
									...
									<th class="center" nowrap>不合格处方数</th>
									<th class="center" nowrap>处方总处方数</th>
									<th class="center" width="150px;">不合格处方数占总不合格处方百分比</th>
									<th class="center" width="150px;">不合格处方数占（查询日期内）医生总处方数</th>
								</tr>
							</thead>
							<tbody>
							<!-- 开始循环 -->	
							<c:choose>
								...
								<tr  >
									<td nowrap class="center">${p1.DOCTOR_NAME }</td>
...
function listExport(){
	window.open(path + "/report/exceedCommonDoctorExport.do"+$("#searchDiv").serialize());
}
function myprint(){
	$("#main-container").hide();
