				...
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
								...
								<form action="prescAnti/prescWorkListPage.do" method="post" name="searchForm" id="searchForm">
...
function prescListExport(){
	window.open(path + "/prescAnti/prescListExport.do?work=1&"+$("#searchForm").serialize()+"&randomFlag="+'${pd.randomFlag}');
}
function myprint(){
	$("#main-container").hide();
...
function randomQuery(){
	$("#randomflag").val("1");
	window.location.href=path + "/prescAnti/prescWorkListPage.do?"+$("#searchForm").serialize();
}
