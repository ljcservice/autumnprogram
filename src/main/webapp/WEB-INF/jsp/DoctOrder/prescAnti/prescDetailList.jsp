		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div >
						<form action="prescAnti/prescDetailList.do" method="post" id="myForm" name="myForm">
...
<!-- 													</a> -->
	...
	function dragSave(){
		...
		$.ajax({
			type: "POST",
			url: basePath + 'prescAnti/saveShortcut.do', 
			...
			success: function(data){
				...
				if(data.result=="ok"){
					...
					reSetCheck();
					//刷新上个页面
					var rsUrl = "prescAnti/checkRsView.do?id=" + id + "&NGROUPNUM=" + data.ngroupnum;
