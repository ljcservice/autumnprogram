				...
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
								...
								<form action="prescAnti/prescListPage.do" method="post" name="searchForm" id="searchForm">
									...
									<div class="check-search nav-search"  >
										...
										<span class="input-icon">
											<input class="nav-search-input" autocomplete="off" id="keywords" type="text" name="keywords" value="${pd.keywords}" placeholder="诊断" maxlength="80" style="width: 120px;" />
											<i class="ace-icon fa fa-search nav-search-icon"></i>
										</span> 
										<span class="input-icon">
...
function detailPresc(id,NGROUPNUM){
	...
	diag.Drag=true;
	diag.Title ="处方详情及点评";
	diag.URL = path + "/prescAnti/prescDetail.do?id=" +  id +"&NGROUPNUM="+NGROUPNUM;
...
function prescListExport(){
	window.open(path + "/prescAnti/prescListExport.do?"+$("#searchForm").serialize());
}
function myprint(){
	$("#main-container").hide();
