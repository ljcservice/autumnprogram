						...
						<div class="col-xs-12"  >
											...
											<div class="tab-content" style="overflow-y:auto;max-height:150px;padding-top: 2px;padding-left: 2px;padding-right: 2px;padding-bottom: 0px;">
												...
												<div id="orderCheck" class="tab-pane fade" >
													<iframe  name="CheckRsFrame" id="CheckRsFrame" scrolling ="auto"" frameborder="0"
														src="prescAnti/checkRsView.do?id=${pat.id}&NGROUPNUM=${pat.NGROUPNUM}" style="margin:0px 0px 0px 0px;width:100%;height: 140px;">
													</iframe>
												</div>
											</div>
										</div>
									...
									<div style="overflow-y:hidden;overflow-x:hidden; ">
										<iframe name="DoctFrame" id="DoctFrame" scrolling="no" frameborder="0" 
											src="prescAnti/prescDetailList.do?id=${pat.id}&NGROUPNUM=${pat.NGROUPNUM}" style="margin:0 auto;width:100%;height: 100%">
										</iframe>
									</div>
						</div>
