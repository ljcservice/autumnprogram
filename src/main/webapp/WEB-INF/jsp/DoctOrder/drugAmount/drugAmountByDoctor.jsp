		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12"  >
							<form action="drugAmount/drugAmountByDoctor.do" method="post" name="searchForm" id="searchForm">
								<div id="searchDiv"  style="vertical-align:bottom;float: left;padding-top: 4px;padding-bottom: 5px;width: 100%;">
									...
									<div class="check-search nav-search">
										...
										医生：
										<span class="input-icon">
											<input class="nav-search-input" autocomplete="off" id="DOCTOR_NAME" type="text" name="DOCTOR_NAME" value="${pd.DOCTOR_NAME}" placeholder="医生名称" maxlength="80" />
											<i class="ace-icon fa fa-search nav-search-icon"></i>
										</span>
									</div>
									<div class="check-search"  >
