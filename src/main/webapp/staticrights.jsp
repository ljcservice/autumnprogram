						...
						<div class="col-xs-12">
							...
							<div class="well">
								<h1 class="grey lighter smaller">
									<span class="blue bigger-125"><i class="icon-sitemap"></i> 当前用户无此操作权限！</span>
								</h1>
								<hr />
								...
								<div>
									...
									<h4 class="smaller">请检查:</h4>
									<ul>
										<li><i class="icon-hand-right blue"></i> 用户角色是不是没有设置</li>
										<li><i class="icon-hand-right blue"></i> 角色的功能权限是不是没有设置</li>
									</ul>
								</div>
